...
import org.fossasia.openevent.core.location.LocationActivity;
import org.fossasia.openevent.core.speaker.SpeakerDetailsActivity;
...
public class SessionViewHolder extends RecyclerView.ViewHolder {
    ...
    @BindView(R.id.speaker_details_linear_layout)
    protected LinearLayout speakerDetailsLinearLayout;

    @BindView(R.id.location_linear_layout)
    ...
    public void bindSession(int type, int colorInTracks, RealmDataRepository realmRepo) {
        ...
        setClickListenersToViews(track);
    ...
    private void setClickListenersToViews(Track track) {
        speakerDetailsLinearLayout.setOnClickListener( v -> {
                String speakerName = session.getSpeakers().first().getName();
                Intent intent = new Intent(this.context, SpeakerDetailsActivity.class);
                intent.putExtra(Speaker.SPEAKER, speakerName);
                intent.putExtra(ConstantStrings.COLOR,track.getColor());
        ...
        locationLinearLayout.setOnClickListener( v -> {
            ...
            intent.putExtra(ConstantStrings.COLOR,track.getColor());
            intent.putExtra(ConstantStrings.LOCATION_NAME, session.getMicrolocation().getName());
